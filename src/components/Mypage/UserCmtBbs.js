...
function UserCmtBbs({token, profile}) {
    ...
    useEffect(() => {
        axios
            .post("http://localhost:3000/mypage/mycmtbbs", requestBody, {
                headers: {
                    ...
                    <div className="mypage-mycommunity-05">
                        <div className="mypage-mycommunity-15">
                            <div  className="mypage-mycommunity-21">
                                <b>
                                    {title}
                                    <Link to={`/userpage/${token.memberseq}/all/mycmtbbs/${bbstag}`}><b className="mypage-mycommunity-16"> {totalCount}</b></Link>
                                </b>
                                <div className="mypage-mycommunity-22">
                                    <Link to={`/userpage/${token.memberseq}/all/mycmtbbs/${bbstag}`}>
                                        전체보기
                                    </Link>
                                </div>
                            </div>
